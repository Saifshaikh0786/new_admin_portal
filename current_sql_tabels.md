...
CREATE TABLE public.course_overrides_v2 (
  university_id uuid NOT NULL,
  batch_id uuid,
  section text,
  course_id uuid NOT NULL,
  ...
  created_at timestamp with time zone NOT NULL DEFAULT now(),
  updated_at timestamp with time zone NOT NULL DEFAULT now(),
  CONSTRAINT course_overrides_v2_pkey PRIMARY KEY (override_id),
  CONSTRAINT course_overrides_v2_university_id_fkey FOREIGN KEY (university_id) REFERENCES public.universities_v2(uid),
  CONSTRAINT course_overrides_v2_batch_id_fkey FOREIGN KEY (batch_id) REFERENCES public.batches_v2(batch_id),
  CONSTRAINT course_overrides_v2_course_id_fkey FOREIGN KEY (course_id) REFERENCES public.courses_v2(course_id),
  CONSTRAINT course_overrides_v2_unit_id_fkey FOREIGN KEY (unit_id) REFERENCES public.units_v2(unit_id),
  CONSTRAINT course_overrides_v2_lecture_id_fkey FOREIGN KEY (lecture_id) REFERENCES public.lectures_v2(lecture_id)
);