...
export default function TeacherDetailView({ teacher, onBack, onSectionSelect, cache = {}, onUpdateCache, user }) {
    ...
    return (
        ...
        <div className="fixed inset-0 z-[120] flex flex-col overflow-hidden animate-in fade-in slide-in-from-right duration-300 bg-gray-50 dark:bg-[#0B0F19]">
            ...
            {/* Header */}
            <div className="relative flex items-center gap-6 p-8 border-b border-gray-200 dark:border-slate-700/50 bg-[var(--card)]/80 dark:bg-slate-900/80 backdrop-blur-xl sticky top-0 z-10 shadow-lg">
                {/* Back Button */}
                <button
                    onClick={onBack}
            ...
            <div className="p-8 overflow-y-auto custom-scrollbar flex-1 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
                    ...
                    <div className="col-span-1 space-y-6">
                        <div className="p-6 rounded-2xl bg-[var(--card)] dark:bg-[var(--card)]/5 border border-gray-200 dark:border-white/10 backdrop-blur-sm shadow-sm dark:shadow-none">
                    ...
                    <div className="col-span-1 lg:col-span-2">
                        ...
                        {teacher.assigned_section && teacher.assigned_section.length > 0 ? (
                                ...
                                {teacher.assigned_section.map((section, idx) => {
                                    ...
                                    return (
                                        <div
                                            ...
                                            className="p-5 rounded-2xl bg-[var(--card)] dark:bg-[var(--card)]/5 border border-gray-200 dark:border-white/5 hover:bg-emerald-50 dark:hover:bg-[var(--card)]/10 hover:border-emerald-500/30 transition-all group cursor-pointer shadow-sm dark:shadow-none relative overflow-hidden"
                                        >
                                            {/* Loading Overlay */}
                                            {isLoading && (
                                                <div className="absolute inset-0 bg-[var(--card)]/50 dark:bg-black/30 backdrop-blur-[1px] flex items-center justify-center z-10 rounded-2xl">
                                            ...
                                            <div className="flex items-center justify-between">
                                                ...
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <button
                                                        ...
                                                        disabled={isLoading}
                                                        className="p-2 rounded-lg opacity-0 group-hover:opacity-100 hover:bg-gray-100 dark:hover:bg-[var(--card)]/10 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-all disabled:opacity-50"
                            ...
                            <div className="p-8 rounded-2xl bg-[var(--card)] dark:bg-[var(--card)]/5 border border-dashed border-gray-200 dark:border-white/10 text-center text-gray-500">
