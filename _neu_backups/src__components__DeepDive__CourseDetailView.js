  ...
  <div className="p-4 space-y-4 animate-pulse">
    {[1, 2, 3].map(i => (
      <div key={i} className="space-y-2">
        <div className="h-12 bg-gray-200 dark:bg-[var(--card)]/5 rounded-xl" />
        <div className="ml-6 space-y-1">
          <div className="h-8 bg-gray-100 dark:bg-[var(--card)]/3 rounded-lg w-4/5" />
          <div className="h-8 bg-gray-100 dark:bg-[var(--card)]/3 rounded-lg w-3/4" />
        </div>
      </div>
    ))}
  </div>
...
const SearchBar = ({ value, onChange, onClear }) => (
  <div className="relative">
    ...
    <input
      ...
      className="w-full pl-9 pr-8 py-2.5 bg-gray-100 dark:bg-[var(--card)]/5 rounded-xl text-sm 
    ...
    {value && (
      <button
        onClick={onClear}
        className="absolute right-2 top-1/2 -translate-y-1/2 p-1 hover:bg-gray-200 dark:hover:bg-[var(--card)]/10 rounded-full transition-colors"
      >
...
export default function CourseDetailView({ course, onBack }) {
    ...
    return (
      <button
        ...
        className={`group w-full text-left p-2.5 rounded-xl text-xs flex items-center gap-2.5 
            ...
            : 'hover:bg-gray-100 dark:hover:bg-[var(--card)]/5 text-gray-600 dark:text-gray-400'
          }`}
      >
        <div className={`shrink-0 w-5 h-5 rounded-full flex items-center justify-center transition-all
                      ${isSelected ? 'bg-[var(--card)]/20' : 'bg-gray-100 dark:bg-[var(--card)]/10'}`}>
        ...
        {contentItem.count && (
          <span className={`px-1.5 py-0.5 rounded-md text-[10px] font-bold tabular-nums
                        ${isSelected ? 'bg-[var(--card)]/20' : 'bg-gray-200 dark:bg-[var(--card)]/10'}`}>
            {contentItem.count}
          </span>
        )}
  ...
  const MainContentArea = ({ content }) => {
      ...
      return (
        <div className="h-full flex flex-col items-center justify-center text-gray-400 p-8">
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            <kbd className="px-3 py-1.5 bg-gray-100 dark:bg-[var(--card)]/10 rounded-lg text-xs font-mono">
              B
            </kbd>
    ...
    //             alt="Question figure"
    //             className="w-full h-auto max-h-80 object-contain bg-[var(--card)] dark:bg-[#0f1523]"
    //           />
    //         </div>
    //       )}

    //       {/* Question Card */}
    //       <div className="bg-[var(--card)] dark:bg-[#0f1523] rounded-2xl p-8 shadow-sm 
    ...
    //             let optionClass = 'bg-gray-50 dark:bg-[var(--card)]/5 border-gray-200 dark:border-white/10';
    ...
    //                           : 'bg-gray-100 dark:bg-[var(--card)]/10 text-gray-500 dark:text-gray-400'
    //                     }`}>
    //                     {showResult && isCorrect ? (
                ...
                return (
                  <div
                    ...
                    className={`w-full p-4 rounded-xl border-2 text-left transition-all duration-300
                        ...
                        : 'bg-gray-50 dark:bg-[var(--card)]/5 border-gray-200 dark:border-white/10'
                      }`}
                  >
                    <div className="flex items-start gap-4">
                      <div className={`shrink-0 w-9 h-9 rounded-lg flex items-center justify-center 
    ...
    const renderCoding = (item) => {
      ...
      return (
        <div className="max-w-4xl mx-auto space-y-6 animate-in fade-in-50 slide-in-from-bottom-4 duration-500">
          {/* Problem Card */}
          <div className="bg-[var(--card)] dark:bg-[#0f1523] rounded-2xl p-6 md:p-8 
              ...
              <div className="space-y-4">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  {[
                    ...
                    <div key={i} className="bg-[var(--card)] dark:bg-[#0f1523] rounded-xl 
                                        border border-gray-200 dark:border-white/5 
                                        overflow-hidden shadow-sm">
                      <div className="px-4 py-2 bg-gray-50/50 dark:bg-[var(--card)]/5 
        ...
        <>
          ...
          {pdfExpanded && (
            <div className="fixed inset-0 z-[100] bg-black/90 backdrop-blur-xl 
              ...
              <div className="w-full h-full bg-[var(--card)] dark:bg-[#0f1523] rounded-2xl 
                ...
                <div className="flex items-center justify-between p-4 border-b 
                        ...
                        {content.pdfs.map((pdf, idx) => (
                          <button
                            ...
                            className={`px-2 py-0.5 rounded text-xs font-medium transition-all
                                ...
                                : 'bg-gray-200 dark:bg-[var(--card)]/10 text-gray-600 dark:text-gray-400'
                              }`}
                          >
                            {pdf.label}
                          </button>
                  ...
                  <button
                    ...
                    className="p-2 hover:bg-gray-100 dark:hover:bg-[var(--card)]/10 
          ...
          <div className="animate-in fade-in-50 duration-500">
            ...
            <div className="flex items-center justify-between mb-4">
                ...
                {content.pdfs.map((pdf, idx) => (
                  <button
                    ...
                    className={`px-4 py-2 rounded-xl text-xs font-bold transition-all
                        ...
                        : 'bg-[var(--card)] dark:bg-[var(--card)]/5 text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-[var(--card)]/10'
                      }`}
                  >
                    {pdf.label}
                  </button>
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-xl bg-[var(--card)] 
                     ...
                     hover:bg-gray-100 dark:hover:bg-[var(--card)]/10 transition-all text-xs font-medium"
              >
            ...
            <div
              className="bg-[var(--card)] dark:bg-[#0f1523] rounded-2xl border border-gray-200 dark:border-white/5 shadow-sm overflow-hidden"
      ...
      return (
        <div className="w-64 shrink-0 hidden xl:block">
          <div className="sticky top-6 space-y-4">
            <div className="p-5 bg-[var(--card)] dark:bg-[#0f1523] border border-gray-200 
                ...
                {content.items.map((_, i) => (
                  <button
                    ...
                    className={`aspect-square rounded-lg text-xs font-bold transition-all 
                        ...
                        : 'bg-gray-100 dark:bg-[var(--card)]/5 text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-[var(--card)]/10'
                      }`}
                  >
                    {i + 1}
                  </button>
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 p-2.5 flex items-center justify-center rounded-xl 
                           bg-gray-100 dark:bg-[var(--card)]/5 border border-gray-200 dark:border-white/5 
                           hover:bg-gray-200 dark:hover:bg-[var(--card)]/10 disabled:opacity-30 
                ...
                {isGroup && (
                  <div className="flex items-center gap-2 xl:hidden">
                    <button
                      onClick={() => setCurrentIndex(c => Math.max(0, c - 1))}
                      disabled={currentIndex === 0}
                      className="p-2 rounded-lg hover:bg-gray-200 dark:hover:bg-[var(--card)]/10 
  ...
  return (
    <PortalWrapper>
    <div className="fixed inset-0 z-[120] flex flex-col bg-slate-50 dark:bg-[#0B0F19] 
      ...
      <header className="flex items-center justify-between p-4 px-6 border-b 
                       border-gray-200 dark:border-white/5 bg-[var(--card)] dark:bg-[#0B0F19] shrink-0">
        <div className="flex items-center gap-4">
          <button
            onClick={onBack}
            className="p-2 -ml-2 hover:bg-gray-100 dark:hover:bg-[var(--card)]/10 
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="p-2 rounded-xl hover:bg-gray-100 dark:hover:bg-[var(--card)]/10 
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        {/* Sidebar */}
        <aside className={`bg-[var(--card)] dark:bg-[#0f1523] border-r border-gray-200 
                  ...
                  <div key={uIdx} className="overflow-hidden">
                    <button
                      ...
                      className={`w-full flex items-center justify-between p-3 rounded-xl 
                          ...
                          : 'hover:bg-gray-50 dark:hover:bg-[var(--card)]/5 border-2 border-transparent'
                        }`}
                    >
                      <div className="flex items-center gap-3 min-w-0">
                            ...
                            <div key={sIdx}>
                              <button
                                ...
                                className={`w-full text-left py-2.5 px-3 rounded-lg flex items-center 
                                    ...
                                    : 'hover:bg-gray-50 dark:hover:bg-[var(--card)]/5'
                                  }`}
                              >
                                {expandedLectures[subKey]
