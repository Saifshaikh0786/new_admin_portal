...
export default function TeacherDetailView({ teacher, onBack, onSectionSelect, cache = {}, onUpdateCache, user }) {
    ...
    return (
        ...
        <div className="fixed inset-0 z-[120] flex flex-col overflow-hidden animate-in fade-in slide-in-from-right duration-300 neu-page">
            ...
            <div className="fixed -bottom-44 -right-40 h-[42rem] w-[42rem] bg-[var(--neu-achieve-soft)] blur-3xl rounded-full pointer-events-none opacity-50 dark:opacity-100" />

            {/* Header */}
            <div className="relative flex items-center gap-6 p-8 border-b border-[var(--neu-divider)] neu-raised backdrop-blur-xl sticky top-0 z-10 shadow-lg">
                {/* Back Button */}
                <button
                    onClick={onBack}
                    className="group p-3 rounded-xl neu-inset hover:from-cyan-500 hover:to-blue-500 dark:hover:from-cyan-600 dark:hover:to-blue-600 text-gray-700 dark:text-gray-300 hover:text-white transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-cyan-500/30 hover:scale-110"
                >
                ...
                <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                        {/* Avatar */}
                        <div className="w-12 h-12 rounded-xl bg-[var(--neu-accent)] flex items-center justify-center text-white font-bold text-xl shadow-lg">
                        ...
                        {/* Loading Indicator */}
                        {loadingAll && (
                            <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-[var(--neu-achieve-soft)] dark:bg-[var(--neu-achieve-soft)] text-blue-600 dark:text-blue-400 text-xs font-medium">
            ...
            <div className="p-8 overflow-y-auto custom-scrollbar flex-1 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
                    ...
                    <div className="col-span-1 space-y-6">
                        <div className="p-6 rounded-2xl neu-raised backdrop-blur-sm">
                    ...
                    <div className="col-span-1 lg:col-span-2">
                        <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-2">
                            <Layers className="w-5 h-5 text-[var(--neu-success)] dark:text-[var(--neu-success)]" />
                            Assigned Sections
                            {loadingAll && (
                        ...
                        {teacher.assigned_section && teacher.assigned_section.length > 0 ? (
                                ...
                                {teacher.assigned_section.map((section, idx) => {
                                    ...
                                    return (
                                        <div
                                            ...
                                            className="p-5 rounded-2xl neu-raised hover:bg-[var(--neu-success-soft)] dark:hover:bg-[var(--card)]/10 hover:border-emerald-500/30 transition-all group cursor-pointer relative overflow-hidden"
                                        >
                                            {/* Loading Overlay */}
                                            {isLoading && (
                                                <div className="absolute inset-0 neu-flat backdrop-blur-[1px] flex items-center justify-center z-10 rounded-2xl">
                                                    <Loader2 className="w-6 h-6 animate-spin text-[var(--neu-success)]" />
                                                </div>
                                            )}

                                            <div className="flex items-center justify-between">
                                                <div className="flex items-center gap-4">
                                                    <div className="w-10 h-10 rounded-lg bg-[var(--neu-success-soft)] flex items-center justify-center text-[var(--neu-success)] dark:text-[var(--neu-success)] group-hover:scale-110 transition-transform">
                                                ...
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <button
                                                        ...
                                                        disabled={isLoading}
                                                        className="p-2 rounded-lg opacity-0 group-hover:opacity-100 hover:bg-[var(--neu-dark)] text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-all disabled:opacity-50"
                                                    ...
                                                    {progress !== null ? (
                                                        <div className="flex items-center gap-3">
                                                            <div className="text-right">
                                                                ...
                                                                <div className={`text-sm font-bold ${progress > 75 ? 'text-[var(--neu-success)] dark:text-[var(--neu-success)]' :
                            ...
                            <div className="p-8 rounded-2xl neu-raised border border-dashed border-[var(--neu-divider)] text-center text-gray-500">
