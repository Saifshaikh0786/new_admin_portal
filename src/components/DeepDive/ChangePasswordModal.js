...
export default function ChangePasswordModal({ isOpen, onClose }) {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-gray-900/60 backdrop-blur-sm p-4 animate-in fade-in duration-300">
                <div className="w-full max-w-md neu-raised rounded-3xl p-8 relative overflow-hidden ring-1 ring-white/20">
                    ...
                    <div className="space-y-1.5">
                        ...
                        <div className="relative group">
                            <input
                                ...
                                className="w-full neu-flat rounded-xl px-4 py-3.5 text-gray-900 dark:text-white focus:border-cyan-500 focus:ring-4 focus:ring-cyan-500/10 outline-none transition-all placeholder-gray-400 font-medium"
